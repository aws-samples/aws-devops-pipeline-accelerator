...
crossaccount_role_arn = "arn:aws:iam::xxxxxxxxxxxx:role/pipelines_crossaccount_role"
repo_approvers_arn = "arn:aws:sts::xxxxxxxxxxxx:assumed-role/CodeCommitReview/*" #Update ARN (IAM Role/User/Group) of Approval Members
builder_image = "xxxxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/dpa-terraform:al2"
